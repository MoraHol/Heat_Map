var contentAsk = '<table><tr><td>Health:</td><td><form><p class="clasificacion"><input id="radio1" type="radio" name="estrellas" value="5"><!--' +
    ...
    '--><label for="radio5">★</label></p></form></td></tr><tr><td>security:</td><td><form><p class="clasificacion"><input id="radio6" type="radio" name="estrellas" value="5"><!--' +
...
'--><label for="radio10">★</label></p></form></td></tr><tr><td>Ambient:</td><td><form><p class="clasificacion"><input id="radio11" type="radio" name="estrellas" value="5"><!--' +
